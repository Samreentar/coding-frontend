...
const featuresData: Feature[] = [
  {
    ...
    paragraph:
      "Effortlessly grade programming exams with precise evaluation and fast feedback, saving teachers' time and ensuring accuracy.",
  },
  {
    id: 2,
    icon: (
    ...
    paragraph:
      "Tailor grading parameters and rubrics to match course requirements for consistent and transparent results.",
  },
  {
    id: 3,
    icon: (
    ...
    paragraph:
      "Leverage AI models to evaluate code submissions with intelligent grading and feedback mechanisms.",
  },
  {
    id: 4,
    icon: (
    ...
    paragraph:
      "Provide students with instant feedback on their submissions, helping them identify mistakes and improve performance.",
  },
  {
    id: 5,
    icon: <svg>...</svg>,
    title: "Time-Saving",
    paragraph:
      "Teachers save valuable time with automated question delivery, code submission handling, and instant grading.",
  },
  {
    id: 6,
    icon: <svg>...</svg>,
    ...
    paragraph:
      "Generate detailed reports for students, including grades, feedback, and performance insights, instantly after submission.",
  },
];
